...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <div className="bg-black text-white min-h-screen flex flex-col font-display selection:bg-white selection:text-black overflow-x-hidden relative">
            {/* CRT Scanlines */}
            <div
            ...
            <div
                className="fixed inset-0 w-full h-full pointer-events-none animate-tv-flicker"
                style={{
            ...
            {/* Navbar */}
            <nav className="w-full fixed top-0 bg-black/90 backdrop-blur-md z-50 border-b border-white/10">
                <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center">
                    <Link
                        href="/work"
                        className="font-mono text-xs uppercase tracking-widest hover:text-neutral-400 transition-colors flex items-center gap-3 group"
                    >
            ...
            <nav className="border-t border-white/10 py-32 bg-black w-full">
